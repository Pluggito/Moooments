    ...
    <div className="max-w-6xl mx-auto p-4 space-y-6">
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-2">
          <h1 className="text-2xl font-semibold text-[#c300f9]">
            Share Your Memories
          </h1>
          <p className="text-gray-600">
            Contribute your photos to the event album and make the moments
            unforgettable.
          </p>
        </div>
        ...
        <div className="rounded-lg overflow-hidden shadow-md flex-wrap md:flex-nowrap lg:flex w-full p-3 gap-3">
          {savedEvents.length > 0 ? (
            savedEvents.map((event, index) => (
              <div
                key={index}
                className="relative aspect-[4/3] p-1 overflow-hidden sm:flex-3"
              >
                <img
            ...
            <div className="p-6 flex-2 text-left">
              ...
              <div className="space-y-4 mt-7">
                ...
                <div className="flex justify-between items-center text-sm text-gray-500">
                  ...
                  <span>
                    {new Date(savedEvents[0].event_date).toLocaleDateString()}
                  </span>
                </div>
              </div>
