...
const EventLink = () => {
  ...
  return (
    <div className="items-center md:mx-auto lg:mx-auto max-w-4xl my-45 p-8 sm:h-full ">
        
        <div className="flex flex-col justify-center  items-center w-full sm:h-[230px] h-[250px] mx-auto gap-5 ">
             ...
             <div className="flex flex-col justify-center items-center gap-4 p-6 w-full bg-[#c300f9] rounded-lg">
                <input type="link" className="w-full p-3 rounded-lg text-black hover:bg-slate-50 border border-gray-500 focus:outline-none bg-white"
