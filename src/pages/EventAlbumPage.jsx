                  ...
                  <div className="flex flex-col md:flex-row gap-3">
                      <div className="relative flex-grow">
                          ...
                          <input
                              id="album-link"
                              type="text"
                              value={`${currentUrl}/${albumId}`}
                              readOnly
                              className="w-full px-4 py-3 border border-zinc-300 rounded-md focus:outline-none focus:ring-2 focus:ring-primary"
                          />
                      </div>
                      <button onClick={handleCopyLink} className="bg-violet-600 p-3 hover:bg-violet-700 text-white md:w-auto font-bold rounded-lg cursor-pointer">
                          Copy Link
                      </button>
                  </div>
