...
const EventAlbumPage = ({ loading, setLoading, handleCopyLink, linkRef, currentUrl, button, navigate }) => {
    ...
    return (
        <div className="min-h-screen bg-white p-4 md:p-6">
            ...
            <div className="max-w-3xl mx-auto">
                ...
                <AlbumItems title={'Your event album is ready!'} handleCopyLink={handleCopyLink} linkRef={linkRef} currentUrl={currentUrl} button={button}/>
            </div>
        </div>
    );
};
