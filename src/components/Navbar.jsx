...
const Navbar = () => {
    ...
    return (
      <nav className={`sm:flex justify-between items-center max-w-6xl mx-auto my-2 inline-block ${location.pathname === '/' ?"absolute top-0 left-0 right-0 z-10" : "inline-block"}`}>
        {/* Brand Name */}
        <NavLink to='/'>
